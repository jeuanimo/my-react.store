      ...
      <div className="about">
        <div className="about-container">
          ...
          <section className="hero-section">
            ...
            {              isEmailVisible == true ? <p> jeuan.mitchell@gmail.com</p> : <p> Click the button to reveal my email address</p>
            }

            <button onClick={showEmailInformation} className='btn btn-dark'> Show my e-mail</button>
            <button onClick={hideEmailInformation} className='btn btn-dark'> Hide my e-mail</button>
