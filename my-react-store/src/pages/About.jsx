...
function About() {
  ...
  function hideEmailInformation() {
    console.log("Hiding email information");
    setIsEmailVisible(false);
  }
  function showEmailInformation() {
    console.log("Showing email information");
    ...
    <div className="about">
      <div className="about-container">
        ...
        <section className="hero-section">
          ...
          <p>
            {user.id}, name: {user.name}, cohort: {user.cohort}
          </p>
          {isEmailVisible == true ? (
            <p>
              <IconMail
              ...
              />
              jeuan.mitchell@gmail.com
            </p>
          ) : (
            <p> Click the button to reveal my email address</p>
          )}

          <button onClick={showEmailInformation} className="btn btn-primary">
            <IconEye size={18} stroke={1.5} style={{ marginRight: "8px" }} />
            Show my e-mail
          </button>
          <button onClick={hideEmailInformation} className="btn btn-primary">
            <IconEyeOff size={18} stroke={1.5} style={{ marginRight: "8px" }} />
            Hide my e-mail
          </button>
        ...
        <section className="values-section">
          <div className="content-wrapper">
            ...
            <div className="values-grid">
              ...
              <div className="value-card">
                <div className="value-icon">
                  <IconDiamond size={64} stroke={1.5} />
                </div>
